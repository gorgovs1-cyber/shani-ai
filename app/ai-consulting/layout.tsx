...
export const metadata: Metadata = {
  ...
  description:
    "ייעוץ והטמעת AI לעסקים: מיפוי תהליכים, אסטרטגיה וסקילים בעברית. שיחת אבחון שבסופה תכנית עבודה ברורה, מה להטמיע, באיזה סדר, ומה יחזיר הכי הרבה שעות. אבחון AI חינם או מעמיק ב-₪950.",

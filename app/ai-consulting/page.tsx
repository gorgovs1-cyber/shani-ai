  ...
  he: {
    ...
    sections: [
      ...
      },
      {
        ...
        p: "רוב כלי ה-AI חושבים באנגלית ומתרגמים, ולכן העברית שיוצאת נשמעת מוזרה ולא מקצועית. אני בונה סקילים, מערכות הוראות שמלמדות את ה-AI לכתוב ולחשוב בעברית טבעית, בדיוק בשפה ובטון של העסק שלכם, כך שמה שיוצא מוכן לשימוש ונשמע כמוכם.",
      },
      {

...
export const metadata: Metadata = {
  ...
  description:
    "אוטומציות n8n + Claude שעובדות 24/7: לוכדות לידים, עונות בוואטסאפ, שולחות מיילים ומזינות CRM לבד. בוט וואטסאפ מ-₪1,200, אוטומציה בודדת מ-₪1,500. פחות עבודה ידנית, יותר תוצאות.",

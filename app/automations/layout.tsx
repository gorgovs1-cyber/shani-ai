...
export const metadata: Metadata = {
  ...
  description:
    "אוטומציות n8n + Claude שעובדות 24/7: לוכדות לידים, עונות בוואטסאפ, שולחות מיילים ומזינות CRM לבד. הצעה אישית אחרי אבחון קצר ושיחה. פחות עבודה ידנית, יותר תוצאות.",

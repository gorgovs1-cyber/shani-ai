...
export const metadata: Metadata = {
  ...
  description:
    "מחירון מלא ופומבי: דף נחיתה 1,500 ש\"ח, אתר 2,400 ש\"ח, מודול בלוג 700 ש\"ח, בוט וואטסאפ 2,400 ש\"ח, סוכן AI 4,900 ש\"ח, מערכת מלאה 7,900 ש\"ח. כל המחירים סופיים, ועלויות כלים תמיד בנפרד ועל שמכם.",

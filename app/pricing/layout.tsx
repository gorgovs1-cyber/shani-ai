...
export const metadata: Metadata = {
  ...
  description:
    "מחירון שקוף: דף נחיתה מ-₪2,400, אתר תדמית קולנועי מ-₪6,500, מערכת AI מלאה מ-₪12,000, ומנוי Shani Care מ-₪390 לחודש. כל המחירים לפני מע\"מ. לא בטוחות? אבחון AI חינם.",

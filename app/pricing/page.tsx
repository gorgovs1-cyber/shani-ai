...
const COPY: Record<"he" | "en", Copy> = {
  he: {
    ...
    intro:
      "פרימיום שמחזיר את עצמו, עם נקודת כניסה נוחה. בוחרים חבילה, או מתחילים במנוי חודשי. לא בטוחות מה מתאים? האבחון החינמי ימליץ.",
    ...
    packages: [
      ...
      },
      {
        ...
        waMsg: "היי שני, מעניינת אותי מערכת ה-AI המלאה (החל מ-₪12,000)",
      },
    ],
    ...
    subIntro:
      "לא רוצות פרויקט גדול עכשיו? נכנסות במנוי חודשי, ואני שומרת על האתר שלכן חי, מעודכן ומשתפר. ביטול בהתראה של 30 יום.",
    subTiers: [
      {
        name: "בסיס",
        price: "₪390 / חודש",
    ...
    auditBoxTitle: "לא בטוחות מה מתאים?",
    auditBoxSub:
      "האבחון החינמי שלי ממפה את העסק וממליץ בדיוק מה כדאי לכן, בלי התחייבות.",
    ...
    faqItems: [
      {
        ...
        a: "תלוי במורכבות. דף נחיתה ממוקד המרה מתחיל ב-₪2,400, אתר תדמית מלא (עד 5 עמודים) מ-₪6,500, ומערכת AI שלמה עם מכונת לידים מ-₪12,000. כל המחירים לפני מע\"מ, עם 50% מקדמה. לא בטוחות? האבחון החינמי ימליץ מה מתאים לכן.",
      },
      {
        q: "אפשר לשלם בתשלומים?",
        a: "כן. העבודה מתחילה עם 50% מקדמה, והיתרה במסירה. לפרויקטים גדולים אפשר לפרוס לתשלומים, נסגור את זה יחד לפי מה שנוח לכן.",
      },
      {
        q: "המחיר כולל מע\"מ?",
      ...
      },
      {
        ...
        a: "כי זה לא אותו מוצר. תבנית וויקס נראית כמו עוד תבנית, נטענת לאט ומוגבלת ב-SEO. אני בונה קוד קאסטום Next.js, מהיר, עם Lighthouse גבוה, SEO אמיתי, אנימציות קולנועיות, ובעלות מלאה שלכן על הקוד. ומעל הכל, אני מחברת אוטומציות ו-AI שאף תבנית לא נותנת. משלמות יותר, אבל מקבלות נכס שמחזיר את עצמו.",
      },
      {
        q: "יש התחייבות לטווח ארוך?",
        a: "בפרויקט חד-פעמי אין שום התחייבות מתמשכת, מסיימים ואתן חופשיות עם הקוד שלכן. מנוי Shani Care הוא חודשי, עם ביטול בהתראה של 30 יום.",
      },
    ],
  },
  en: {

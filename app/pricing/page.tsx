...
const COPY: Record<"he" | "en", Copy> = {
  he: {
    ...
    title: "מחירים",
    intro:
      "כאן תוכלו לראות מה כלול בכל אפשרות וכמה היא עולה, ולפני שנתחיל נעבור יחד על מה שמתאים לעסק שלכם.",
    groups: [
      {
        title: "אתרים",
        href: "/websites",
        ...
        items: [
          ...
          },
          {
            ...
            more: {
              ...
              forWho: "עסקים שצריכים אתר ברור להצגת השירותים ולקבלת פניות.",
    ...
    steps: [
      { no: "01", title: "אבחון קצר", desc: "ממלאים טופס ללא עלות על העסק ועל המשימות שחוזרות על עצמן." },
      { no: "02", title: "כיוונים ראשוניים", desc: "אני עוברת על העסק וחוזרת אליכם תוך יום עסקים עם שניים-שלושה כיוונים." },
      { no: "03", title: "שיחת היכרות", desc: "נדבר עשרים דקות בטלפון או בוואטסאפ כדי להבין יחד מה נכון לבנות." },
    ...
    values: [
      {
        ...
        desc: "אפשר להעביר למערכת משימות שחוזרות על עצמן, כמו שמירת פרטים ושליחת תזכורות.",
      },
      {
        title: "מעקב אחרי הפניות",
        desc: "פרטי הפניות נשמרים במקום אחד, כדי שיהיה קל יותר לראות למי צריך לחזור.",
      },
      {
        title: "אתר שמציג אתכם",
        desc: "אנשים יכולים להבין מה אתם עושים, להכיר את העבודה שלכם ולפנות אליכם.",
      },
      {
        title: "הכלים מחוברים",
        desc: "מחברים את האתר לכלים של העסק לפי הצורך, כדי להפחית העתקות ומעברים ביניהם.",
      },
    ],

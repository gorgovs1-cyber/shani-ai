...
export const metadata: Metadata = {
  ...
  description:
    "אתרים קולנועיים בקוד קאסטום Next.js: מהירים, עם SEO אמיתי, אנימציות GSAP ובעלות מלאה על הקוד. דף נחיתה מ-₪2,400, אתר תדמית מ-₪6,500. בונה אתרים לעסקים בתל אביב, ירושלים, חיפה ואונליין בכל הארץ.",

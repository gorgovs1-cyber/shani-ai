...
export default function Footer(){
 ...
 <div className="footer-brand"><div className="footer-brand-lockup"><Logo height={30}/><strong dir="ltr">Shani Gorgov</strong></div></div>
 <div className="footer-columns">
 <nav aria-label={he?"עמודי האתר":"Site pages"}>{pages.map(([label,href])=><Link key={href} href={href}>{label}</Link>)}</nav>

export const dict = {
  he: {
    ...
    problemTitle:'העסק שלכם ימשיך לעבוד גם כשאתם לא',
    problemLines:[
  ...
  en: {
    ...
    problemTitle:'Your business keeps working when you are not',
    problemLines:[

export const dict = {
  he: {
    ...
    heroTitle:'העסק שלכם ימשיך לעבוד גם כשאתם לא.',
    ...
    workKicker:'04 · עבודות', workTitle:'פרויקטים נבחרים', workSub:'מערכות AI, אוטומציות, מוצרים דיגיטליים ואתרים שבניתי לעסקים.',
    ...
    problemTitle:'הפניות לא הולכות לאיבוד, הן פשוט מחכות יותר מדי',
    problemLines:[
      'הפניות מגיעות מוואטסאפ, מאינסטגרם, מהטלפון ומהטופס באתר, ואתם מנסים לזכור למי עניתם ולמי לא.',
      'בסוף היום מישהו נשכח, ובדרך כלל זה דווקא מי שהיה הכי קרוב לסגור.',
      'זה לא חוסר סדר, זה פשוט יותר מדי ערוצים ואדם אחד באמצע.'
    ],
    ...
    aboutKicker:'05 · עליי', aboutTitle:'עליי', stat1:'שנות ניסיון עסקי', stat2:'זמן תגובה',
    processKicker:'06 · איך אני עובדת', processTitle:'מרעיון למוצר.', processSub:'תהליך ברור בחמישה שלבים, אתם מעורבים לאורך כל הדרך.',
    ...
    faqKicker:'08 · שאלות נפוצות', faqTitle:'כל מה שרציתם לדעת.',
    faqItems:[
  ...
  en: {
    ...
    role:'SHANI AI CREATOR',
    heroTitle:'Your business keeps working when you are not.',
    ...
    problemTitle:'Enquiries do not get lost, they just wait too long',
    problemLines:[
      'Enquiries arrive on WhatsApp, Instagram, the phone and the form on your site, and you are left trying to remember who you answered and who you did not.',
      'By the end of the day someone has been missed, and it is usually the one who was closest to buying.',
      'That is not disorganisation. It is too many channels and one person in the middle.'
    ],
    ...
    priceKicker:'07 · What it costs',
    priceTitle:'Prices are always published',
    priceSub:'The price on the list is the price. No extras that show up at the end.',
    priceItems:[
      {label:'Landing page', price:'1,500 NIS'},
      {label:'Business website', price:'2,400 NIS'},
      {label:'Full AI system', price:'7,900 NIS'}
    ],
    priceCta:'See the full price list',
    aboutKicker:'05 · About', aboutTitle:'About', stat1:'years in business', stat2:'response time',
    processKicker:'06 · How I work', processTitle:'From idea to a product.', processSub:'A clear five-step process, you stay involved the whole way.',
    ...
    faqKicker:'08 · FAQ', faqTitle:'Everything you need to know.',
    faqItems:[

export const dict = {
  he: {
    ...
    faqItems:[
      {q:'כמה עולה לבנות אתר או אוטומציה לעסק?', a:'במחירי השקה: דף נחיתה קולנועי מ-₪890, אתר תדמית מלא מ-₪1,900, ומערכת AI שלמה מ-₪3,900. אוטומציה בודדת מ-₪900 ובוט וואטסאפ מ-₪700. יש גם מנוי חודשי מ-₪250. כל המחירים לפני מע"מ, ובדף המחירים יש פירוט מלא. לא בטוחים מה מתאים? האבחון החינמי ימליץ.'},
  ...
  en: {
    ...
    faqItems:[
      {q:'How much does a website or automation cost?', a:'At launch pricing: a cinematic landing page from ₪890, a full brand website from ₪1,900, and a complete AI system from ₪3,900. A single automation from ₪900 and a WhatsApp bot from ₪700. There\'s also a monthly membership from ₪250. All prices exclude VAT, and the pricing page breaks it down in full. Not sure what fits? The free audit will recommend.'},

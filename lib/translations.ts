export const dict = {
  he: {
    ...
    faqItems:[
      {q:'כמה עולה לבנות אתר או אוטומציה לעסק?', a:'המחירון מפורסם במלואו בעמוד המחירים. דף נחיתה 1,500 ₪, אתר 2,900 ₪, אוטומציה בודדת 1,400 ₪, בוט וואטסאפ 2,400 ₪, סוכן AI 4,900 ₪ ומערכת מלאה 7,900 ₪. אלה מחירים סופיים, ועלויות כלים שוטפות תמיד בנפרד ועל שמכם.'},
  ...
  en: {
    ...
    faqItems:[
      {q:'How much does a website or automation cost?', a:'The full price list is published on the pricing page. Landing page 1,500 NIS, website 2,900 NIS, single automation 1,400 NIS, WhatsApp bot 2,400 NIS, AI agent 4,900 NIS and a full system 7,900 NIS. These are final prices, and running tool costs are always separate and in your name.'},
